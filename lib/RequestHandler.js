...
class RequestHandler {
    ...
    constructor() {
        /**
         * List of middleware to process incomming request.
         *
         * @private
    ...
    /**
     * Handle the incomming server request.
     *
     * @public
     * @param {@moonwalkingbits/apollo-http.Request} request Incomming server request.
     * @return {Promise.<@moonwalkingbits/apollo-http.Response>} Server response.
     */
    handle(request) {
